...
public class GrabObject : MonoBehaviour
{
    ...
    private void TryGrab()
    {
        ...
        if (ARAVRInput.GetDown(ARAVRInput.Button.HandTrigger, ARAVRInput.Controller.RTouch))
        {
            ...
            */
            ...
            // 2. 일정 영역 안에 폭탄이 있으니까
            // 영역 안에 있는 모든 폭탄 검출
            // 마우스 위치에 가상이 구를 만들어서 구 영역 안에 해당하는 정보를 저장?
    ...
    private void TryUnGrab()
    {
        ...
        // 쿼터니온 공식
        // 쿼터니온이란 3차원 공간에서 평행한 선이 소실점으로 만나는 것? ex) 기찻길
        // angle1 = Q1, angle2 = Q2
        // angle1 + angle2 = Q1 * Q2
        ...
        if (ARAVRInput.GetUp(ARAVRInput.Button.HandTrigger, ARAVRInput.Controller.RTouch))
        {
            ...
            // 객체의 각도가 돌아가면서 날라가도록 구현
            float angle;
            Vector3 axis;
            deltaRotation.ToAngleAxis(out angle, out axis);
            Vector3 angularVeloctiy = (1.0f / Time.deltaTime) * angle * axis;
            //grabbedObject.GetComponent<Rigidbody>().angularVeloctiy = angularVeloctiy;
